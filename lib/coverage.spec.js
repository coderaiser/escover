...
test('escover: coverage: write: empty', async (t) => {
...
test('escover: coverage: write', async (t) => {
...
test('escover: coverage: read', async (t) => {
    const {read} = await reImport('./coverage');
...
test('escover: coverage: read: error', async (t) => {
...
test('escover: coverage: read: data', async (t) => {
