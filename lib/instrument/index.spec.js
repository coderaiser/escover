...
test('escover: instrument: generate: json', (t) => {
    const source = montag`
        {
            "hello": "world"
        }
    ...
    const [error] = tryCatch(instrument, '/instrument-generate-json.js', source);
    
    globalThis.__fileEntries.delete('/instrument-generate-json.js');
    
    t.equal(error.message, '/instrument-generate-json.js: Missing semicolon. (2:11)');
    t.end();
});
